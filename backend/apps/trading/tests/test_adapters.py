...
class TestBinanceAdapterL1(unittest.TestCase):
    ...
    def test_binance_get_positions_filters_zero(self, mock_client_cls):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = [
            {'positionAmt': '0', 'entryPrice': '0', 'unRealizedProfit': '0', 'leverage': '1', 'symbol': 'BTCUSDT'},
            {'positionAmt': '100', 'entryPrice': '49000', 'unRealizedProfit': '100', 'leverage': '10', 'symbol': 'ETHUSDT'},
        ]
...
class TestOKXAdapterL1(unittest.TestCase):
    ...
    def test_okx_get_positions_filters_zero(self, mock_client_cls):
        ...
        mock_response.json.return_value = {
            'data': [
                {'instId': 'BTC-USDT-SWAP', 'pos': '0', 'avgEntryPx': '0', 'upl': '0', 'lever': '10'},
                {'instId': 'ETH-USDT-SWAP', 'pos': '5', 'avgEntryPx': '3000', 'upl': '50', 'lever': '5'},
            ]
        }
        mock_client.get.return_value = mock_response
        adapter._client = mock_client
